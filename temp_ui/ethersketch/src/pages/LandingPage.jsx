    ...
    <>
      ...
      <nav className="lp-nav">
        ...
        <div className="lp-nav-actions">
          ...
          <button className="btn-primary" onClick={() => navigate('/dashboard')}>Get Started Free</button>
        </div>
      </nav>
        ...
        <div className="hero-inner">
          <div className="hero-text fade-up">
            ...
            <div className="hero-btns">
              <button className="btn-primary btn-large" onClick={() => navigate('/dashboard')}>Start for Free →</button>
      ...
      <section id="pricing" className="lp-section">
        ...
        <div className="pricing-grid fade-up">
          {[
            { tier:'Free', price:'$0', period:'forever', popular:false, features:['Up to 3 projects','2 collaborators','Basic templates','PNG export','7-day history'], cta:'Get Started', onClick: () => navigate('/dashboard') },
            { tier:'Pro', price:'$12', period:'per month', popular:true, features:['Unlimited projects','10 collaborators','All templates','All export formats','Unlimited history'], cta:'Start Pro Trial', onClick: () => navigate('/dashboard') },
      ...
      <div className="cta-banner fade-up">
        ...
        <button className="btn-primary btn-large" onClick={() => navigate('/dashboard')}>Get Started Free — It's Free Forever →</button>
      </div>
